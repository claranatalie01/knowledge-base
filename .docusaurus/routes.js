...
export default [
  {
    ...
    component: ComponentCreator('/knowledge-base/zh-HK/docs', 'a89'),
    routes: [
      {
        path: '/knowledge-base/zh-HK/docs',
        component: ComponentCreator('/knowledge-base/zh-HK/docs', '491'),
        routes: [
          {
            path: '/knowledge-base/zh-HK/docs',
            component: ComponentCreator('/knowledge-base/zh-HK/docs', 'bb0'),
            routes: [
              {
              ...
              },
              {
                ...
                component: ComponentCreator('/knowledge-base/zh-HK/docs/LLM/Langchain', 'e29'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
